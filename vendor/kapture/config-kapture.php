...
$strings = [
    ...
    "finalizar"                   => 'Finalizar',
    "salvar_gravacao_ottflix"     => 'Salve sua gravação no CloudStudio',
    "title_captura"               => 'Captura ',
    "salvar_ottflix"              => 'Salvar no CloudStudio',
    ...
    "ottflix"                     => 'CloudStudio',
    "falha_upload_ottflix"        => 'Falha no Upload para a CloudStudio',
    "abortado_upload_ottflix"     => 'Upload para a CloudStudio foi abortado!',
...
if( file_exists( __DIR__ . "/../../repository_ajax.php" ) && file_exists( __DIR__ . "/../../../../config.php" ) ) {
    ...
    $strings[ "destino" ] = "cloudstudio-moodle";
    $logo                 = "https://eadtech.cloudstudio.com.br/img/logo/logo.svg";
    $rootPath             = "";

    foreach( $strings as $key => $value ) {
        if( $key != "destino" ) {
            $string = @get_string( $key, "mod_cloudstudio" );
            if( $string ) {
                $strings[ $key ] = $string;
            }
        }
