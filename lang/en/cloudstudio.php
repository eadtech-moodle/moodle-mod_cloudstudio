...
$string['cloudstudio:view_report'] = "View CloudStudio report";
...
$string['identificador_help'] = 'The "Cloud Studio Identifier" is a unique video code used to connect your Moodle to Cloud Studio.';
...
$string['nocloudstudios'] = 'No CloudStudio instance available at the moment.';
$string['none_camera'] = 'Do not use the camera.';
$string['openpopup'] = 'Open in Popup';
$string['openpopup_desc'] = 'When selected, this option will open the content in a new popup window.';
...
$string['safety_desc'] = 'What should the Player display?';
$string['safety_id'] = 'Student ID';
$string['safety_none'] = 'None';
...
$string['token'] = 'Cloud Studio API TOKEN';
$string['token_desc'] = 'Enter the API TOKEN provided by Cloud Studio. This token is used to authenticate and authorize communication between your site and Cloud Studio. To obtain an account on Cloud Studio, please send an email to tecnologia@eadtech.com.br.';
