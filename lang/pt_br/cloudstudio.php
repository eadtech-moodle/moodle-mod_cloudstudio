...
$string['token'] = 'TOKEN da API do Cloud Studio';
$string['token_desc'] = 'Insira o TOKEN da API fornecido pelo Cloud Studio. Este token é utilizado para autenticar e autorizar a comunicação entre seu site e o Cloud Studio. Para obter uma conta no Cloud Studio, envie um e-mail para tecnologia@eadtech.com.br.';
