...
define(["jquery", "core/ajax", "mod_cloudstudio/player_render", "core/str"], function($, Ajax, PlayerRender, getString) {
    return mod_form = {
        id_name               : null,
        id_videourl           : null,
        ...
        init : function(engine, lang, courseSection) {
            ...
            mod_form.fitem_id_playersize = mod_form.find_fitem("playersize");
        ...
        id_videourl_change : function() {
            ...
            var promise = (Ajax.call([{
                methodname : 'mod_cloudstudio_services_opengraph_getinfo',
                args       : {
